...
class Config(Model):
    ...
    def _populate_from_data(self, data):
        ...
        self.FileLogLevel = self._get_config_setting(data, 'FileLogLevel', "INFO")
        ...
        self.WriteVersionInfoToResults = self._get_config_setting(data, 'WriteVersionInfoToResults', True)
